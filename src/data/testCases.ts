...
export const TEST_CASES: TestCase[] = [
  ...
  { id: 317, category: 'Sales', subCategory: 'Discounts', prompt: 'Show total discounts given this quarter', expectedBehavior: 'Aggregates all line-item and invoice-level discounts for the quarter' },
  ...
  { id: 324, category: 'Sales', subCategory: 'Invoices', prompt: 'List invoices with partial payments pending', expectedBehavior: 'Shows invoices where some payment received but balance remains' },
  ...
  { id: 329, category: 'Sales', subCategory: 'Payments', prompt: 'Show bounced cheque or failed payment attempts', expectedBehavior: 'Lists payments that failed or were reversed with details' },
  ...
  { id: 338, category: 'Purchases', subCategory: 'Bills', prompt: 'Show purchase bills with TDS deducted', expectedBehavior: 'Lists bills where TDS was applied with section and amount' },
  { id: 339, category: 'Purchases', subCategory: 'Orders', prompt: 'Show purchase orders with price variance from quotes', expectedBehavior: 'Compares PO prices against original vendor quotations' },
  { id: 340, category: 'Purchases', subCategory: 'Vendors', prompt: 'List vendors with expiring contracts this quarter', expectedBehavior: 'Shows vendor agreements due for renewal in current quarter' },
  { id: 341, category: 'Purchases', subCategory: 'Bills', prompt: 'Show duplicate bill detection results', expectedBehavior: 'Flags potential duplicate vendor bills by amount, date, and vendor' },
  ...
  { id: 345, category: 'Purchases', subCategory: 'Orders', prompt: 'Show blanket purchase orders and their utilization', expectedBehavior: 'Displays standing POs with consumed vs remaining quantities' },
  ...
  { id: 356, category: 'Inventory', subCategory: 'Valuation', prompt: 'Compare FIFO vs weighted average valuation', expectedBehavior: 'Shows side-by-side valuation under both methods' },
  { id: 357, category: 'Inventory', subCategory: 'Movement', prompt: 'Show slow-moving inventory over 180 days', expectedBehavior: 'Lists items with no transactions in the last 180 days' },
  { id: 358, category: 'Inventory', subCategory: 'Movement', prompt: 'Show inter-warehouse stock transfers this month', expectedBehavior: 'Lists all stock transfer entries between warehouses' },
  { id: 359, category: 'Inventory', subCategory: 'Stock Levels', prompt: 'Show negative stock items', expectedBehavior: 'Lists items with stock balance below zero indicating data issues' },
  { id: 360, category: 'Inventory', subCategory: 'Reorder', prompt: 'Show economic order quantity suggestions', expectedBehavior: 'Calculates optimal order quantity based on demand and costs' },
  ...
  { id: 364, category: 'Inventory', subCategory: 'Movement', prompt: 'Show stock adjustment entries this quarter', expectedBehavior: 'Lists manual stock adjustments with reasons and approvals' },
  { id: 365, category: 'Inventory', subCategory: 'Valuation', prompt: 'Show landed cost calculation for imported items', expectedBehavior: 'Includes freight, duties, and insurance in item cost computation' },
  { id: 366, category: 'Inventory', subCategory: 'Reorder', prompt: 'Show safety stock analysis', expectedBehavior: 'Calculates recommended safety stock levels based on demand variability' },
  ...
  { id: 375, category: 'GST', subCategory: 'Filing', prompt: 'Show late fee and interest on delayed GST filing', expectedBehavior: 'Calculates penalties for late GSTR filing by period' },
  ...
  { id: 392, category: 'Reports', subCategory: 'Financial', prompt: 'Show segment-wise profitability report', expectedBehavior: 'Breaks down P&L by business segment or division' },
  ...
  { id: 411, category: 'Fixed Assets', subCategory: 'Depreciation', prompt: 'Show impairment losses recognized this year', expectedBehavior: 'Lists assets where carrying value was written down' },
  ...
  { id: 422, category: 'Expense Claim', subCategory: 'Policy', prompt: 'Show claims missing receipt attachments', expectedBehavior: 'Lists expense claims without uploaded supporting documents' },
  ...
  { id: 432, category: 'Accounting', subCategory: 'Ledger', prompt: 'Show suspense account balance and aging', expectedBehavior: 'Displays items parked in suspense with age of each entry' },
  ...
  { id: 439, category: 'Accounting', subCategory: 'Period End', prompt: 'Show month-end closing checklist status', expectedBehavior: 'Displays completion status of each closing activity' },
  ...
  { id: 441, category: 'Accounting', subCategory: 'Ledger', prompt: 'Show accounts with unusual balance direction', expectedBehavior: 'Flags accounts with debit balance when credit expected or vice versa' },
  ...
  { id: 460, category: 'Drive', subCategory: 'Access', prompt: 'Show documents shared with external users', expectedBehavior: 'Lists files accessible to users outside the organization' },
  { id: 461, category: 'Drive', subCategory: 'Storage', prompt: 'Show duplicate files detected in drive', expectedBehavior: 'Lists potential duplicate documents by name and hash' },
  ...
  { id: 463, category: 'Drive', subCategory: 'Storage', prompt: 'Show files not accessed in over 6 months', expectedBehavior: 'Lists stale files that may be candidates for archival' },
  ...
  { id: 466, category: 'Drive', subCategory: 'Access', prompt: 'Show documents pending review or sign-off', expectedBehavior: 'Lists files in review workflow awaiting action' },
  ...
  { id: 472, category: 'Comments', subCategory: 'Mentions', prompt: 'Show comments where I am mentioned', expectedBehavior: 'Lists comments with @mention of the current user' },
  ...
  { id: 494, category: 'Taxes', subCategory: 'TDS', prompt: 'Show TDS certificate (Form 16A) generation status', expectedBehavior: 'Lists vendors with pending or generated TDS certificates' },
  ...
  { id: 496, category: 'Taxes', subCategory: 'TDS', prompt: 'Show lower deduction certificate tracking', expectedBehavior: 'Lists vendors with Section 197 certificates and validity dates' },
  { id: 497, category: 'Taxes', subCategory: 'Income Tax', prompt: 'Show MAT (Minimum Alternate Tax) computation', expectedBehavior: 'Calculates book profit and MAT liability under Section 115JB' },
  ...
  { id: 499, category: 'Taxes', subCategory: 'Income Tax', prompt: 'Show deferred tax asset and liability summary', expectedBehavior: 'Calculates timing differences creating DTA/DTL with amounts' },
  ...
  { id: 502, category: 'Taxes', subCategory: 'TDS', prompt: 'Show non-resident payment TDS compliance', expectedBehavior: 'Lists payments to non-residents with TDS under Section 195' },
  ...
  { id: 516, category: 'Your Workspace', subCategory: 'Activity', prompt: 'Show login activity and session history for my account', expectedBehavior: 'Lists recent login times, IP addresses, and session durations' },
];
